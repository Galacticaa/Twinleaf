                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" required class="form-control" id="formRadius" name="radius">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" required class="form-control" id="formAccountsTarget" name="accounts_target">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="formProxyTarget">Proxies</label>
                                <input type="number" min="0" required class="form-control" id="formProxyTarget" name="proxy_target">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="formDbThreads">Threads</label>
                                <input type="number" min="0" class="form-control" id="formDbThreads" name="db_threads">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="formSpeedScan">
                                    <input type="checkbox" name="speed_scan" id="formSpeedScan" value="1" checked>
                                    Speed Scan
                                </label>
                                <div class="input-group">
                                    <label for="formWorkers" class="sr-only">Workers</label>
                                    <input type="number" min="0" class="form-control" id="formWorkers" name="workers">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="formBeehive"><input type="checkbox" id="formBeehive" name="beehive" value="1"> Beehive Mode</label>
                                <div class="input-group">
                                    <label for="formWorkersPerHive" class="sr-only">Workers per Hive</label>
                                    <input type="number" min="0" class="form-control" id="formWorkersPerHive" name="workers_per_hive">
                                    <div class="input-group-addon">
                                        per hive
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" min="0" class="form-control" id="formScanDuration" name="scan_duration">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" min="0" class="form-control" id="formRestInterval" name="rest_interval">
                                    <div class="input-group-addon">minutes</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" class="form-control" id="formMaxEmpty" name="max_empty">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="formMaxFailures">Max Failures</label>
                                <input type="number" min="0" class="form-control" id="formMaxFailures" name="max_failures">
                            </div>
                        </div>
                    </div>
                </div>
