...
return [
    ...
    */
    ...
    'action_icons' => [
        ...
        'update'     => 'edit bg-aqua',
        'delete'     => 'minus-circle bg-red',
        'remove'     => 'minus-circle bg-red',
        'regenerate' => 'refresh bg-orange',
        'replace'    => 'refresh bg-orange',
        'start'      => 'play bg-green',
        'stop'       => 'pause bg-orange',
        'upload'     => 'cloud-upload bg-blue',
        'activate'   => 'ok-circle',
        'log_in'     => 'sign-in',
        'log_out'    => 'sign-out',
    ],
    ...
    */
    'content_types' => [
        'map' => [
            'model' => Twinleaf\Map::class,
        ],
        'map_area' => [
            'model' => Twinleaf\MapArea::class,
        ],
    ],
